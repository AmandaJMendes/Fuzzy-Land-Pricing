...
area['large']      = fuzz.trimf(area.universe, [400, 700, 1100])
area['very large'] = fuzz.trimf(area.universe, [900, 2000, 2000])
# area.view()
...
rules.append(ctrl.Rule(area['very large'] & dist_to_av['close'], price['very high']))
